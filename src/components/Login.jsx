...
const Login = () => {
  ...
  return (
    <section className="md:ml-4 md:mx-10 lg:ml-52 lg:mx-48 box-content max-w-screen-xl bg-gray-400 border rounded-xl p-6 mt-20 sm:mx-4 sm:mt-[68px] sm:ml-12 sm:mb-6 xs:mt-16">
      ...
      <p className="text-gray-800 mb-6 text-justify lg:text-lg xs:mb-4 xs:text-[20px] ">
        <strong>SocialGus</strong> is an exciting social platform designed to
        connect people from all over the world. With an intuitive interface and
        powerful features, <strong>SocialGus</strong> offers you a unique
        experience to share moments, interact with friends, and discover new
        connections.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        ...
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          />
          <div className="text-center my-4 grid grid-rows-2 ">
            <h4 className="font-bold text-red-700 xs:text-[24px] ">
              Do not have an account?{" "}
            </h4>
            <NavLink
              to="/register"
              className="text-blue-700 hover:text-red-700 underline text-lg font-bold xs:text-[22px] mt-4">
              Sign up here!
            </NavLink>{" "}
            <span className="xs:text-[20px]">Or</span>
            <NavLink
              to="/reset"
              className="text-blue-700 hover:text-red-700  text-lg font-bold xs:text-[22px] xs:mb-12">
              Reset your password!
            </NavLink>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
        <div>
          ...
          <p className="text-gray-800 text-justify xs:mb-6">
            ...
            wall, share stories, and keep your followers updated on what's
        ...
        <div>
          ...
          <p className="text-gray-800 text-justify xs:mb-4">
      ...
      <p className="text-gray-800 mt-12 text-center xs:mb-4 xs:text-[20px] ">
